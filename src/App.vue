<!-- <template>
  <div>
    <q-input v-model="pokemon" label="Ingresa el nombre" stack-label :dense="dense" />
...
async function traer(){
  let res = await axios.get(`https://pokeapi.co/api/v2/pokemon/${pokemon.value}`)
...
<style>
  ...
  <!-- <q-circular-progress
        :value="stat.cantidad / 100 * 100"
        size="50px"
        :thickness="0.22"
        :color="getStatColor(stat.nombre)"
        track-color="grey-3"
        class="q-ma-md"
      /> -->
